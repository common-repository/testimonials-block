...
function my_block_cgb_block_assets() { // phpcs:ignore
	...
	wp_enqueue_style(
		'my_block-cgb-style-css-custom', // Handle.
	...
	// Styles.
	wp_enqueue_style( 'tr-icofont', plugins_url( 'dist/assets/css/icofont.css', dirname( __FILE__ ) ) );

	wp_enqueue_style('tr-slick', plugins_url( 'dist/assets/css/slick.css', dirname( __FILE__ ) ) );
	...
	wp_enqueue_script('slick-script',  plugins_url( 'dist/assets/js/slick.min.js', dirname( __FILE__ ) ), array('jquery'),'1.0.0',true);
